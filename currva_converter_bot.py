...
def send_welcome(message):
    message_text = (
        ...
        "Бывает, заходишь в чат, в котором сидят люди из разных стран, и там пишут: «а я купил за 100 фунтов телевизор».\n"
        ...
        "А ещё бот поддерживает инлайн-режим: можно самому написать \"@currvaconverter_bot я только что купил телевизор за 1500 драм!\" "
